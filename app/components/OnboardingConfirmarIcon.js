...
export default function OnboardingConfirmarIcon({ width = 160 }) {
  ...
  return (
    <svg width={width} height={(width * 120) / 160} viewBox="0 0 160 120" fill="none" aria-hidden="true">
      ...
      <path d="M27 35c6-4 90-4 96 0" stroke="rgba(255,255,255,0.12)" strokeWidth="2" strokeLinecap="round" className="pl-onb-fill" />
      ...
      <g className="pl-onb-fill" opacity="0.55">
        <line x1="32" y1="48" x2="32" y2="72" stroke="var(--paper-dim)" strokeWidth="1.6" />
        <line x1="37" y1="48" x2="37" y2="72" stroke="var(--paper-dim)" strokeWidth="1" />
        <line x1="41" y1="48" x2="41" y2="72" stroke="var(--paper-dim)" strokeWidth="2" />
        <line x1="46" y1="48" x2="46" y2="72" stroke="var(--paper-dim)" strokeWidth="1" />
      </g>
