    ...
    <div className="pl-overlay" onClick={(e) => e.target === e.currentTarget && onClose()}>
      <div className="pl-modal">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="pl-field"><label>Sigla (opcional)</label><input name="sigla" maxLength={5} defaultValue={time.sigla || ''} placeholder="Ex: FCP" /></div>
          ...
          {arenas.length > 0 && (
            <div className="pl-field">
              ...
              <select className="pl-select" name="arenaId" defaultValue={time.arena_id || ''} style={{ width: '100%' }}>
          ...
          <div className="pl-field"><label>Técnico (opcional)</label><input name="tecnico" defaultValue={time.tecnico || ''} /></div>
          <div style={{ display: 'flex', gap: 10 }}>
            <div className="pl-field" style={{ flex: 1 }}>
              <label>Dia fixo de jogo (opcional)</label>
              <select className="pl-select" name="diaJogo" defaultValue={time.dia_jogo || ''} style={{ width: '100%' }}>
                <option value="">Não informar</option>
            ...
            <div className="pl-field" style={{ flex: 1 }}>
              ...
              <input name="horarioJogo" type="time" defaultValue={time.horario_jogo || ''} />
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: 10 }}>
            <div className="pl-field" style={{ flex: 1 }}>
              ...
              <input name="maxJogadores" type="number" min={1} max={99} defaultValue={time.max_jogadores || 15} />
            </div>
            <div className="pl-field" style={{ flex: 1 }}>
              <label>Recrutamento</label>
              <select className="pl-select" name="recrutamento" defaultValue={time.recrutamento || 'fechado'} style={{ width: '100%' }}>
