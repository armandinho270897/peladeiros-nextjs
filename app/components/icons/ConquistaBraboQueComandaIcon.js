export default function ConquistaBraboQueComandaIcon({ size = 40 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 64 64" fill="none" aria-hidden="true">
      ...
      <path
        d="M20 27l4 4 8-9 8 9 4-4 1 12H19z"
        fill="var(--gold)" stroke="var(--ink)" strokeWidth="1.3" strokeLinejoin="round"
      />
      <rect x="19" y="39" width="26" height="4" rx="1" fill="var(--gold)" stroke="var(--ink)" strokeWidth="1.1" />
